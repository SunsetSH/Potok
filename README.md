...
- 🎙️ **Голосовые заметки** — запись с микрофона, устойчивая к прерываниям; расшифровка полностью офлайн. Приложение не несёт встроенной модели — при первом запуске предлагает скачать одну из каталога (Whisper base/small, GigaAM v3 для русского, Parakeet TDT v3 мультиязычный), с размером, рейтингом качества и прогресс-баром; модель можно сменить или удалить в любой момент в настройках
...
ASR-модель не входит в сборку — при первом запуске приложение само предложит скачать одну из каталога (или выберите вручную в настройках).
