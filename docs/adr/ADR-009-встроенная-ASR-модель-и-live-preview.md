...
Дата: 2026-07-18  
Статус: частично суперседед [[ADR-012]] (2026-07-19) — пункты 1–3 (bundled
default, first-run bootstrap из assets) отменены: приложение больше не несёт
встроенной модели, вместо этого первый запуск предлагает скачать одну из
каталога. Пункты 4–7 (manifest/hash контракт, near-live preview, RMS-gate)
остаются в силе.
