...
Историческое уточнение 2026-07-18: реализованный здесь продуктовый режим
сессий удалён по ADR-010 и миграции schema v3. Разделы о нём ниже описывают
состояние WP-04 на момент закрытия, а не актуальное поведение.
